var config = {
    ...
    chapters:[
        ...
        },
        {
            ...
            description: 'The University of Iowa will return to mostly in-person, face-to-face instruction in the fall 2021 semester. Face coverings and vaccinations will not be mandatory for students, faculty, and staff to return to campus. However, the UI urges everyone eligible to receive a vaccine to do so. The UI will continue to follow Centers for Disease Control and Prevention cleaning guidelines and test symptomatic individuals and asymptomatic individuals exposed to COVID-19. Read more on the University of Iowa website: <a href="https://coronavirus.uiowa.edu/fall-2021" target="blank">https://coronavirus.uiowa.edu/fall-2021</a>.',
            location: {
        ...
        },
        {
            ...
            description: 'The University of Minnesota requires students, faculty, and staff to wear face coverings in university buildings. The university announced on Aug. 9 that it would require students to get the COVID-19 vaccine after Food and Drug Aministration approval of the vaccine, adding it to the list of required vaccinations for attending Minnesota. Faculty and staff are not required to get vaccinated, but those who are unvaccinated will be asked to confirm how frequently they are tested, be tested if they experience symptoms, and be tested if exposed to COVID-19. Read more on the University of Minnesota website: <a href="https://safe-campus.umn.edu/return-campus/covid-19-updates" target="blank">https://safe-campus.umn.edu/return-campus/covid-19-updates</a>.',
            location: {
        ...
        },
        {
            ...
            description: 'The University of Illinois at Urbana-Champaign is requiring all students who are able to be fully vaccinated before returning to campus for the fall 2021 semester. Individuals who can&#39;t get vaccinated for medical or other reasons are required to continue participating in the COVID-19 testing program. Students, faculty, and staff must complete an on-campus COVID-19 test and receive a negative result, or have a university-verified vaccination record card to access university buildings. Read more on the University of Illinois website: <a href="https://covid19.illinois.edu/" target="blank">https://covid19.illinois.edu/</a>.',
            location: {
        ...
        },
        {
            ...
            description: 'Northwestern University is requiring all students to complete a COVID-19 vaccination form in order to register for on-campus classes this fall. Students, faculty, and staff will be required to wear a face covering in indoor spaces regardless of their vaccination status. The only exceptions to this rule are private offices, personal residence or dorm rooms, or when eating or drinking. Unvaccinated students are expected to comply with heightened COVID-19 testing, symptom monitoring, and quarentining/isolating. Read more on the Northwestern University website: <a href="https://www.northwestern.edu/coronavirus-covid-19-updates/" target="blank">https://www.northwestern.edu/coronavirus-covid-19-updates/</a>.',
            location: {
        ...
        },
        {
            ...
            description: 'The University of Wisconsin-Madison is requiring all students, employees, and visitors to wear face coverings in university buildings. UW-Madison is providing on-campus COVID-19 testing and vaccinations and is encouraging those eligible to get vaccinated. The university is asking individuals to register COVID-19 vaccination cards with a university web portal. Read more on the University of Wisconsin website: <a href="https://covidresponse.wisc.edu/" target="blank">https://covidresponse.wisc.edu/</a>.',
            location: {
        ...
        },
        {
            ...
            description: 'Indiana University Bloomington is requiring all students be vaccinated before returning to campus and starting classes. The university will provide vaccinations on campus for those not fully vaccinated yet and those returning from an international location. Individuals who seek approval for a vaccination exemption will still need to particpate in mitigation testing and wear a face covering. Read more on the Indiana University website: <a href="https://www.iu.edu/covid/index.html" target="blank">https://www.iu.edu/covid/index.html</a>.',
            location: {
        ...
        },
        {
            ...
            description: 'Purdue University is allowings students to choose to either to provide proof of vaccination by Aug. 13 or particpate in routine COVID-19 surveillance testing. Ten students who are fully vaccinated will win $9,992 each, the equivalent of in-state tuition, for choosing to get vaccinated. Students, faculty, staff, and visitors are required to wear masks indoors regardless of vaccination status. Read more on the Purdue University website: <a href="https://protect.purdue.edu/" target="blank">https://protect.purdue.edu/</a>.',
            location: {
        ...
        },
        {
            ...
            description: 'Rutgers University is requiring students to upload their vaccination by Aug. 1 in order to continue their academic work at the university. Students who do not upload their vaccine information will have their account access revoked, and those living on campus will not receive their dorm or apartment keys. Rutgers is requiring masks in all indoor facilies and unvaccinated individuals with continue to be tested for COVID-19 weekly. Read more on the Rutgers University website: <a href="https://coronavirus.rutgers.edu/" target="blank">https://coronavirus.rutgers.edu/</a>.',
            location: {
        ...
        },
        {
            ...
            description: 'The University of Maryland is requiring face coverings be worn indoors regardless of vaccination status. Students, faculty, and staff are required to get vaccinated. Vaccinated individuals don&#39;t need to get tested for COVID-19 regularly. Unvaccinated individuals need to get tested twice weekly. Maryland will resume operating at full capacity during the semester. Read more on the University of Maryland website: <a href="https://www.umd.edu/4Maryland" target="blank">https://www.umd.edu/4Maryland</a>.',
            location: {
